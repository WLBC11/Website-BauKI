...
import { Send, Square, HelpCircle, Paperclip, X, FileText, Image as ImageIcon, Mic, ZoomIn, Wand2, Sparkles } from 'lucide-react';
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center justify-between px-3 pb-3 pt-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  >
                    <Paperclip className="h-5 w-5 text-gray-700 dark:text-gray-300 transition-all duration-200 opacity-70 hover:opacity-100" />
                  </Button>
