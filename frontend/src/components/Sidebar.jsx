...
import { Plus, MessageSquare, Trash2, Menu, PanelLeftClose, User, LogOut, Search, ChevronDown, Settings, Key, UserX, FileText, BarChart3, HelpCircle, MoreHorizontal, Pencil, Sun, Moon } from 'lucide-react';
          ...
          <div className="px-3 pb-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-100 dark:bg-[#2f2f2f] border border-gray-300 dark:border-[#3f3f3f] rounded-lg text-sm text-gray-900 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-500"
              />
            </div>
          </div>
        )}
                ...
                return (
                  <div
                    ...
                    className={`group relative mx-2 rounded-lg cursor-pointer transition-colors duration-150
                      ${isActive ? 'bg-gray-200 dark:bg-[#2f2f2f] text-gray-900 dark:text-white' : 'text-gray-900 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#2f2f2f]/50'}`}
