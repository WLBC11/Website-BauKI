              ...
              {filteredConversations.map(conv => {
                ...
                return (
                  <div
                    ...
                    title={conv.title}
                  >
                    <div className="flex items-center py-2 pl-3 pr-16">
                    ...
                    {/* Delete button - at right-12 position */}
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        deleteConversation(conv.id);
                      }}
                      className={`absolute right-12 top-1/2 -translate-y-1/2 p-1 hover:bg-[#3f3f3f] rounded transition-all duration-200 z-20 ${
